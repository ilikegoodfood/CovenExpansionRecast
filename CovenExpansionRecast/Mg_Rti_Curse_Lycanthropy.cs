...
namespace CovenExpansionRecast
{
    public class Mg_Rti_Curse_Lycanthropy : Ritual
    {
        ...
        {
            return Soulstone != null && Soulstone.CapturedSoul != null && Soulstone.GetSoulType() == SoulType.Werewolf && Soulstone.CapturedSoul.house != null && !(Soulstone.CapturedSoul.society is SG_AgentWanderers) && Soulstone.CapturedSoul.society != map.soc_dark && !Soulstone.CapturedSoul.house.curses.Any(c => c is Curse_Lycanthropy);
        }
