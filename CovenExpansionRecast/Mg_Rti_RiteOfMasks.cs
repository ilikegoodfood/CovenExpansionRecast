...
namespace CovenExpansionRecast
{
    public class Mg_Rti_RiteOfMasks : Ritual
    {
        ...
        {
            return Soulstone.CapturedSoul != null && Soulstone.CapturedSoul.house != ua.person.house && ua.person.traits.Any(t => t is T_MasteryCurseweaving curseweaving && curseweaving.level > 0);
        }
